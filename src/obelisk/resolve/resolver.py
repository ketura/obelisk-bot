...
from obelisk.resolve.side_buffs import SideBuffIndex, load_side_buff_index
from obelisk.resolve.traps import TrapIndex, load_trap_index
...
def build_resolver(
    ...
    from obelisk.resolve._overrides import OVERRIDES_TEXT
