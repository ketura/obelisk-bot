...
from obelisk.extract._pattern_passive_map import lookup_attack_passive
from obelisk.models.common import Faction, ResourceCost
from obelisk.models.unit import AttackSlot, Unit, UnitAbility, UnitAttack, UnitStats
...
def extract_units_enriched(paths: CorePaths) -> UnitExtractionResult:
    ...
    * everything else             → KEEP — emit a UnitAbility row
    ...
    from obelisk.extract.views import load_views
    from obelisk.match import AuditReport, audit_unit
