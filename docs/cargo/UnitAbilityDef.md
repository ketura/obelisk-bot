...
```mediawiki
{{#cargo_declare:_table=UnitAbilityDef
...
- [`UnitAbilityActiveDef`](UnitAbilityActiveDef.md) — splinter for `active`.
- [`UnitAbilityPassiveDef`](UnitAbilityPassiveDef.md) — splinter for `passive`.
- [`UnitAbilityConditionalDef`](UnitAbilityConditionalDef.md) — splinter for
  `conditional_passive`.
- [`UnitAbilityGlobalDef`](UnitAbilityGlobalDef.md) — splinter for
  `global_passive`.
- [`UnitAbilityAuraDef`](UnitAbilityAuraDef.md) — splinter for `aura`.
- [`UnitAbilityStatPassiveDef`](UnitAbilityStatPassiveDef.md) — splinter for
  `stat_passive`.
- [`UnitAbilityTranslation`](UnitAbilityTranslation.md) — i18n companion
  (1:1).
- [`UnitDef`](UnitDef.md) — parent on `unit_id = id` (N:1).
